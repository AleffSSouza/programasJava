...
public class Boxe {
    ...
    public static void main(String[] args) {
        ...
        if ((peso>=47.64) && (peso<=48.99)){
            JOptionPane.showMessageDialog(null, "Sua categoria de boxe é: Mosca rápida");
        }
        ...
        if ((peso>=50.36) && (peso<=51.71)){
            JOptionPane.showMessageDialog(null, "Sua categoria de boxe é: mosca grande");
        }
        ...
        if ((peso>=58.98)  && (peso<=61.23)){
         ...
         if ((peso>=63.6) && (peso<=66.68)){
            JOptionPane.showMessageDialog(null, "Sua categoria de boxe é: Mediano");
        }

         if ((peso>=66.69) && (peso<=69.85)){
            JOptionPane.showMessageDialog(null, "Sua categoria de boxe é: Super Mediano");
        }
